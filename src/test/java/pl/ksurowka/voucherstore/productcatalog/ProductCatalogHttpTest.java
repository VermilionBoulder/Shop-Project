...
public class ProductCatalogHttpTest {
    ...
    public static final String PRODUCT_DRAFT_1 = "product draft 1";
    @LocalServerPort
    int localServerPort;
    ...
    @Test
    public void listsAllAvailableProducts() {
        //Arrange
        thereIsDraftProduct(PRODUCT_DRAFT_1);
        ...
        assertThat(response.getBody())
                ...
                .doesNotContain(PRODUCT_DRAFT_1);
    }
    ...
    private void thereIsReadyToSellProduct(String productName) {
        var id = productCatalogFacade.createProduct();
        productCatalogFacade.updateProductDetails(id, productName, null);
        productCatalogFacade.applyPrice(id, BigDecimal.TEN);
    }
