...
public class JDBCPlaygroundTest {
    ...
    public static final String PRODUCT_ID = "0694f9a6-4556-11eb-b378-0242ac130002";
    @Autowired
    ...
    public void loadsProduct() {
        var query = "INSERT INTO `products_catalog__products` (`id`, `description`, `picture`, `price`) values " +
                "('ff99ad90-4555-11eb-b378-0242ac130002', 'p1 description', 'p1 picture', 20.20)," +
                "('0694f9a6-4556-11eb-b378-0242ac130002', 'p2 description', 'p2 picture', 20.20)" +
                ";";
    ...
    @Test
    public void loadsProductMapViaLambda() {
        var query = "INSERT INTO `products_catalog__products` (`id`, `description`, `picture`, `price`) values " +
                "('ff99ad90-4555-11eb-b378-0242ac130002', 'p1 description', 'p1 picture', 20.20)," +
                "('0694f9a6-4556-11eb-b378-0242ac130002', 'p2 description', 'p2 picture', 20.20)" +
                ";";
    ...
    @Test
    public void allowsAddingProduct() {
